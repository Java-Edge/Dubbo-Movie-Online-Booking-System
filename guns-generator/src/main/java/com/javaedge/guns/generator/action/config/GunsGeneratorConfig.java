package com.javaedge.guns.generator.action.config;
...
public class GunsGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void globalConfig() {
        ...
        globalConfig.setAuthor("javaedge");
    }
    ...
    protected void packageConfig() {
        ...
        packageConfig.setEntity("com.javaedge.guns.admin.common.persistence.model");
        packageConfig.setMapper("com.javaedge.guns.admin.common.persistence.dao");
        packageConfig.setXml("com.javaedge.guns.admin.common.persistence.dao.mapping");
    }

    protected void contextConfig() {
        contextConfig.setProPackage("com.javaedge.guns.admin");
        contextConfig.setCoreBasePackage("com.javaedge.guns.core");
