DROP TABLE IF EXISTS javaedge_user_t;
CREATE TABLE javaedge_user_t(
...
insert into javaedge_user_t(user_name,user_pwd,nick_name,user_sex,birthday,email,user_phone,address,head_url,life_state,biography)
    values('admin','0192023a7bbd73250516f069df18b500','隔壁泰山',0,'2019-07-31','admin@gmail.com','13888888888','北京市海淀区朝阳北路中南海国宾馆','films/img/head-img.jpg',0,'没有合适的伞，我宁可淋着雨');
insert into javaedge_user_t(user_name,user_pwd,nick_name,user_sex,birthday,email,user_phone,address,head_url,life_state,biography)
    values('javaedge','5e2de6bd1c9b50f6e27d4e55da43b917','华为人',0,'2019-08-20','javaedge@gmail.com','13866666666','南京市雨花台区华为路','films/img/head-img.jpg',1,'我喜欢隔壁泰山');
